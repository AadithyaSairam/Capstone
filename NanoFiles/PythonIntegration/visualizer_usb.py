...
# ── CONFIG ────────────────────────────────────────────────────────────────
sensor = SerialSensor(device_name="ESP32_LoadCells", threshold=3, sample_count=1)
...
# ── ASSIGN REGION IDs ─────────────────────────────────────────────────────
region_ids = build_regions(cellcenters)
mesh["region"] = region_ids

# ── COLOR MAPPING ─────────────────────────────────────────────────────────
def update_mesh_colors(pressure_values):
    colors   = np.full((mesh.n_cells, 3), 0.25)   # dark grey default
...
# Clean close on window X button
